...
ÖNCEKİ SAYFADA ÇOK UZUN YAPTIĞIMIZ İŞLEMİ INNER JOIN İLE YAPACAĞIZ (2 TABLO)
...
$Sorgu = $VeritabaniBaglantisi->query("SELECT * FROM uyeler INNER JOIN siparisler ON uyeler.id = siparisler.uyeid",PDO::FETCH_ASSOC);
...
if($Sorgu){
 ...
 $KayitSayisi = $Sorgu -> rowCount(); 
   ...
   if($KayitSayisi>0){
     ...
     echo $satirbilgi["id"]." | ".$satirbilgi["adisoyadi"]." | ".$satirbilgi["yas"]." | ".$satirbilgi["sehir"]." | ".$satirbilgi["uyeid"]." | ".$satirbilgi["urunadi"]." | ".$satirbilgi["urunfiyati"]."<br><br><br>"; 
     }
