...
$sorgu = $VeritabaniBaglantisi->query("SELECT * FROM bilgiler",PDO::FETCH_ASSOC); // PDO::FETCH_...   tanımlamazsak php otomatik olarak FETCH_BOTH tanımlar. 
if($sorgu){
foreach($sorgu as $yaz){
   
    //PDO::FETCH_ASSOC İLE ALDIĞIMIZ İÇİN VERİLERİ SADECE SÜTUN İSİMLERİ İLE ÇAĞIRABİLİRİM , PHP NİN OTOMATİK OLARAK SÜTUNLARA VERDİĞİ RAKAMLAR İLE ÇAĞIRAMAM
echo "ID : ".$yaz["id"]."<br>";                        
