...
/*
Bu sayfada bindParam yerine bindValue kullanacağım (bindParam ile bindValue aynı işleri yapar bindParam için kullanılan özellikler vs. bindValue için de geçerlidir)
*/
...
$Sorgu->bindValue(2,$SonDeger,PDO::PARAM_INT);
$Sorgu->execute();                                  
if($Sorgu){
