...
verilere erişim şekli de belirtilebilir.. MESELA ADI ALİ OLANLARI GETİR DEDİM 
fetchAll() hepsini getirir , fetch() ilk bulduğunı getirir yani 1 kişi getirir.
...
$sorgu = $VeritabaniBaglantisi->query("SELECT * FROM bilgiler",PDO::FETCH_BOTH); // PDO::FETCH_...   tanımlamazsak php otomatik olarak FETCH_BOTH tanımlar. 
if($sorgu){
