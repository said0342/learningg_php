...
$Sorgu = $VeritabaniBaglantisi->query("SELECT MIN(yas) AS kucukyas FROM uyeler")->fetch(); // yas yerine adisoyadi id falan da yazabiliriz 


if($Sorgu){

  
  echo "En kucuk yas : ".$Sorgu["kucukyas"];
